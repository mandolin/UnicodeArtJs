...
export type MessageKey =
  ...
  | 'artFont.render.direction'
  | 'extension.json.invalid'
  | 'extension.document.object'
  | 'extension.document.format'
  | 'extension.document.version'
  | 'extension.document.unknownField'
  | 'extension.field.required'
  | 'extension.field.invalid'
  | 'extension.license.expression'
  | 'extension.license.provenance'
  | 'extension.resource.path'
  | 'extension.resource.capability'
