...
| Integration | 宿主、浏览器、Web、VS Code、桌面、侧载和 Compatible 应用集成边界。 | `docs/host-integration.md`、`docs/host-sideload-boundary.md`、`docs/web-integration.md`、`docs/vscode-extension-integration.md`、`docs/desktop-host-baseline.md` |
...
| Release | 发布门禁、发布材料、性能基线、VS Code 发布和运行时依赖。 | `docs/release-gate.md`、`docs/release-materials.md`、`docs/performance-and-release-plan.md`、`docs/vscode-extension-release-checklist.md`、`docs/runtime-sbom.md` |
