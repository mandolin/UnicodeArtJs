...
| Extension | UAEM、官方扩展、语义布局、UAF 和创作生态。 | `docs/extension-sdk.md`、`docs/extension-manifest.md`、`docs/semantic-uaf-beta.md`、`docs/uaf-authoring.md`、`docs/creative-ecosystem.md` |
