...
| 贡献者 | 如何提交问题、示例或作品？ | Contribute、Support、Gallery Submission、Gallery Review |
...
| Integration | 宿主、浏览器、Web、VS Code、侧载和 Compatible 应用集成边界。 | `docs/host-integration.md`、`docs/host-sideload-boundary.md`、`docs/web-integration.md`、`docs/vscode-extension-integration.md` |
| Configuration | 字体、宽字素、语言、输出环境和配置模型。 | `docs/config-model-vnext.md`、`docs/glyph-width-layout.md`、`docs/font-behavior.md` |
| Extension | UAEM、官方扩展、语义布局、UAF 和创作生态。 | `docs/extension-sdk.md`、`docs/extension-manifest.md`、`docs/semantic-uaf-beta.md`、`docs/uaf-authoring.md`、`docs/semantic-document-authoring.md`、`docs/creative-ecosystem.md` |
| Compatibility | 浏览器、Node、字体、adapter、已知限制、迁移和生态边界。 | `docs/migration-guide.md`、`docs/known-limitations.md`、`docs/optional-input-adapters.md`、`docs/ecosystem-compatibility.md` |
| Release | 发布门禁、发布材料、性能基线、VS Code 发布和运行时依赖。 | `docs/release-gate.md`、`docs/release-materials.md`、`docs/performance-and-release-plan.md`、`docs/runtime-sbom.md` |
| Contribute | 反馈、画廊投稿、审核回退、支持和公开路线。 | `docs/support.md`、`docs/gallery-submission.md`、`docs/gallery-review.md`、`docs/roadmap.md` |
