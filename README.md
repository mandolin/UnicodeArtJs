...
| 你想做什么 | 推荐入口 |
| --- | --- |
| 直接试用图片或文字转换 | [在线工具站](https://mandolin.github.io/UnicodeArtJs/) |
| 在项目中调用转换能力 | [`unicode-art-js`](https://www.npmjs.com/package/unicode-art-js) |
| 在终端批处理图片或文本 | [`unicode-art-cli`](https://www.npmjs.com/package/unicode-art-cli) |
| 在 VS Code 中转换选中文本 | [VS Code 插件](https://marketplace.visualstudio.com/items?itemName=mandolin.unicode-art-js-vscode) |
...
- 在线工具站提供 JSON 编辑器，可编辑、校验、预览和导入导出语义文档与 UAF 艺术字。
